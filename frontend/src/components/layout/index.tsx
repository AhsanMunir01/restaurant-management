...
export const BaseLayout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-background text-foreground transition-colors duration-300">
      ...
      <aside
        className={cn(
          "fixed top-0 bottom-0 left-0 z-55 flex w-64 flex-col bg-card border-r border-border transition-transform duration-300 ease-in-out md:hidden",
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        {/* Header */}
        <header className="flex h-16 items-center justify-between px-6 border-b border-border bg-card/50 backdrop-blur-md">
