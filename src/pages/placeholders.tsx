...
import { Grid3X3, BookOpen, ShoppingBag, ChefHat, CreditCard, Boxes, Users, Info } from "lucide-react"
...
export const TablesPage: React.FC = () => (
  <PageSkeleton
    title="Tables & Layout Management"
    description="Real-time visual map of the dining room floor, table statuses, and reservations."
...
export const MenuPage: React.FC = () => (
  <PageSkeleton
    ...
    description="Organize categories, update prices, manage availability, and modify dishes."
    roles={["admin", "manager", "waiter"]}
